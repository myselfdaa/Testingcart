...
//		regpage.setFirstName(dataMap.get("firstName"));    // its default nethod for name only one value.
		regpage.setFirstName(BaseClass.randomeString()); // it is a randome input for name insteed of above thing. 
